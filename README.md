...
See the file [CI.yml](https://github.com/werdfgy/lab04/blob/main/.github/workflows/ci.yml)

Github Actions - [All workflows](https://github.com/werdfgy/lab04/actions)
